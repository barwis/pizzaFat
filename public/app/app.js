...
angular
	.module("app", ['ngRoute','home', 'creator', 'basket'])
	...
	.config(['$routeProvider', function($routeProvider) {
		...
		.when('/creator', {
			templateUrl: 'app/components/creator/creatorView.html',
			controller: 'CreatorCtrl',
			controllerAs: 'creator'
		})
		.when('/basket', {
			templateUrl: 'app/components/basket/basketView.html',
			cotnroller: 'BasketController',
			controllerAs: 'basket'
		})
